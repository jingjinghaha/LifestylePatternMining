...
'''
def build_daily_single_diet_index_with_time4DC(subjectID,n):
...
'''
def build_daily_single_activity_index_with_time4DC(subjectID,n):
...
def build_daily_single_activity_index_with_time(subjectID,n):
    ...
    for key1 in temp: 
        ...
        for key2 in temp[key1]:
            ...
            if acttype != 'none':
                if acttype in singleActType_dict[key1]:
                    singleActType_dict[key1][acttype] += freq
                else:
                    singleActType_dict[key1][acttype] = freq
    # print singleActType_dict
    return singleActType_dict
