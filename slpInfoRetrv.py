...
#    vo2max = sum(Vo2max)/float(len(Vo2max))
    ...
    print 'Average age is: ', np.mean(Age), np.std(Age)
    print 'Men, Women: ', gender
    print 'Average height is: ', np.mean(Height), np.std(Height)
    print 'Average weight is: ', np.mean(Weight), np.std(Weight)
    print 'Average BMI is: ', np.mean(BMI), np.std(BMI)
    print 'Average fat_free is: ', np.mean(FatFree), np.std(FatFree)
    print 'Average fat_mass is: ', np.mean(FatMass), np.std(FatMass)
    print 'Average perc_fat is: ', np.mean(PercFat), np.std(PercFat)
    print 'Average vo2max is: ', np.mean(Vo2max), np.std(Vo2max)
