...
# def dietTypeSimilarityDict(dist = 'TFIDFCosin'):
	# dietSimilarity_dict = {} 
	# available_list = ['039','044','045','048','049','050','051','052','053','054','056','057','058','059','060','061','063','064','065','066','067','068','069','070','071','072','073','074','075']
	# if dist == 'TFIDFCosin':
		# dietSimilarity_dict = utilise.TFIDFCosin('dietType')
	# else: 
		# i = 0
...
def dietTypeSimilarityTable(dist = 'TFIDFCosin'):
	print 'in dietTypeSimilarityTable()'
	excelTable('DietType',dist)
